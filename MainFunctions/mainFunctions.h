...
class MainFunctions {
public:
    static CollisionInfo* FindCollision(double ox, double oy, double oz, double dx, double dy, double dz, SceneInfo* sceneInfo, double maxDist, int depth=0, bool earlyQuit=false);
